...
<head>
    ...
    <style>
        body { font-family: -apple-system, system-ui, sans-serif; background: #0b0f19; color: #e2e8f0; margin: 0; padding: 20px; display: flex; flex-direction: column; gap: 20px; }
        ...
        #canvas3d { width: 100%; height: 340px; border-radius: 12px; background: #030712; border: 1px solid #1f2937; cursor: grab; }
        ...
        .badge { display: inline-block; padding: 6px 14px; border-radius: 20px; font-weight: bold; font-size: 13px; margin-top: 10px; }
        .danger { background: #dc2626; color: white; animation: pulse 2s infinite; }
        .success { background: #16a34a; color: white; }
        pre { background: #030712; padding: 15px; border-radius: 8px; color: #38bdf8; font-family: monospace; border: 1px solid #1f2937; overflow-x: auto; font-size: 14px; }
    ...
    <script>
        ...
        const telemetryChart = new Chart(ctx, {
            ...
            options: {
                ...
                scales: {
                    y:  { type: 'linear', position: 'left',  grid: { color: '#1f2937' }, ticks: { color: '#9ca3af' } },
